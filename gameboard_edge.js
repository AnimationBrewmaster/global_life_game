            ...
            "stage": {
                ...
                content: {
                    dom: [
                        ...
                        {
                            id: 'audio-button2',
                            symbolName: 'audio-button',
                            type: 'rect',
                            rect: ['964px', '611px', '54', '53', 'auto', 'auto'],
                            cursor: 'pointer',
                            transform: [[],[],[],['0.66038','0.66038']]
                        },
                        {
                            id: 'btnTips',
                            symbolName: 'rountBtn',
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            symbolName: 'btnInvisible',
                            cursor: 'pointer',
                            rect: ['533px', '34px', '128', '128', 'auto', 'auto']
                        },
                        {
                            type: 'rect',
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            preload: 'auto',
                            type: 'audio',
                            source: ['_final_sfx/click.mp3', '_final_sfx/click.ogg'],
                            id: 'click',
                            rect: ['0', '0', '320px', '45px', 'auto', 'auto'],
                            display: 'none',
                            tag: 'audio'
                    ...
                    dom: [
                        {
                            ...
                            id: 'audio-button',
                            opacity: '1',
                            clip: 'rect(0px 44px 53px 0px)',
                            fill: ['rgba(0,0,0,0)', '_images/audio-button.png', '0px', '0px']
                        },
                        {
                            preload: 'auto',
                            type: 'audio',
                            source: ['_final_audio/background-music.mp3'],
                            id: 'background-music',
                            rect: ['0', '0', '320px', '45px', 'auto', 'auto'],
                            display: 'none',
                            tag: 'audio'
